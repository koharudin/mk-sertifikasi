  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <SubMenu label={"Master"} icon={<i className='tabler-files' />}>
            <MenuItem href={`/${locale}/master/quiz`} target='_blank'>
              Quiz
            </MenuItem>
            <MenuItem href={`/${locale}/master/sekolah`} target='_blank'>
              Sekolah
            </MenuItem>
            <MenuItem href={`/${locale}/master/user`} target='_blank'>
              User
            </MenuItem>
          </SubMenu>

        </SubMenu>
        <MenuSection label={"Contoh"} icon={<i className='tabler-files' />}>
